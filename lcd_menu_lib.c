...
GUI_set_menu menu(int rotate1, int rotate2, int rotate3, int button1, int button2, int button3, GUI_set_menu menu_arr)
{
	...
	if(menu_arr.currentScreen==5) rotate2_switch = (int) ( (double)rotate2)*(14/255);
	else if(menu_arr.currentScreen==6) (rotate2_switch = (int) ( (double)rotate2)*(3/85));
	else (rotate2_switch = ((int) ( (double)rotate2)*(2/17)));
